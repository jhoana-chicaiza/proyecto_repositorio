...
?>
    ...
    <body background="./img/fondo2.jpg" style="background-size: cover">
		...
		while($mostrar=mysqli_fetch_array($result)){
			?>
			<tr>
			<td><img src="vista.php?id= <?php echo $mostrar[0] ?>" width="200" height="200" /></td>
        ...
        <table class=" table-hover " style="text-align: center; border: none; solid #000000; font-family: fantasy; font-size:20; " WIDTH="100%"  >
		<TR>
